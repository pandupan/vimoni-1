...
const PluginsPage = () => {
  return (
    <div className="relative flex gap-10 w-full">
      ...
      <div className="py-20">
        <div className="flex gap-8 w-full py-4">
        ...
        <div className="flex flex-row text-theme-text py-8 gap-12">
          <button className="bg-[#EDEEF2] flex flex-col gap-2 justify-center items-center container px-8 w-[242px] h-[168px] rounded-xl plugin-shadow">
            <Image
